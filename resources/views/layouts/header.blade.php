    ...
    <div class="container mx-auto px-4 py-2 flex items-center justify-between h-16">
        ...
        <nav class="hidden md:flex items-center space-x-2">
            @can('mahasiswa')
                ...
                <a href="{{ route('mahasiswa.bimbingan.index') }}" class="px-4 py-2 text-sm font-medium transition-colors duration-200 rounded-lg {{ request()->routeIs('mahasiswa.bimbingan.*') ? 'bg-green-600 text-white shadow-sm' : 'text-gray-700 hover:bg-green-50 hover:text-green-600' }}">
                    <div class="flex items-center space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
