            ...
            <div class="h-full flex flex-col rounded-2xl glass-effect shadow-2xl">
                ...
                <div class="p-6 text-center border-b border-white/20">
                    ...
                    <div class="mt-6 p-4 rounded-xl glass-effect">
                        <div class="flex items-center space-x-3 group transition-all duration-200  rounded-lg p-2 -m-2">
                            <div class="relative">
                                <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center ring-2 ring-white/30  transition-all duration-200">
                                ...
                                <div class="absolute -bottom-1 -right-1 w-4 h-4 bg-green-400 rounded-full border-2 border-white  transition-colors duration-200"></div>
                            </div>
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('admin.dashboard') }}"
                               class="menu-item flex items-center px-4 py-3 text-white rounded-xl hover:bg-white/10 transition-all duration-300 group {{ request()->routeIs('admin.dashboard') ? 'active-menu' : '' }}">
                        ...
                        <li>
                            <a href="{{ route('admin.mahasiswa') }}"
                               class="menu-item flex items-center px-4 py-3 text-white rounded-xl hover:bg-white/10 transition-all duration-300 group {{ request()->routeIs('admin.mahasiswa') ? 'active-menu' : '' }}">
                                <div class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-white/20 transition-colors duration-300">
                        ...
                        <li>
                            <a href="{{ route('admin.dosen') }}"
                               class="menu-item flex items-center px-4 py-3 text-white rounded-xl hover:bg-white/10 transition-all duration-300 group {{ request()->routeIs('admin.dosen') ? 'active-menu' : '' }}">
                                <div class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-white/20 transition-colors duration-300">
                        ...
                        <li>
                            <a href="{{ route('admin.pengajuanta') }}"
                               class="menu-item flex items-center px-4 py-3 text-white rounded-xl hover:bg-white/10 transition-all duration-300 group {{ request()->routeIs('admin.pengajuanta') ? 'active-menu' : '' }}">
                                <div class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-white/20 transition-colors duration-300">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 18">
                                        <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
                                    </svg>
                                </div>
                                <span class="font-medium">Pengajuan TA</span>
                            </a>
                        </li>
                    </ul>
                </nav>
                ...
                <div id="error-alert" class="mb-6 p-4 bg-red-50 border border-red-200 text-red-800 rounded-xl shadow-sm" role="alert">
                    <div class="flex items-center">
                        ...
                        <button class="ml-auto text-red-600 hover:text-red-800" onclick="this.parentElement.parentElement.remove()">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M4.293 salt="Profile Picture"4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                            </svg>
                        </button>
                    </div>
                </div>
