            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-green-50 rounded-lg p-6 border border-green-100">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="" class="mt-4 inline-flex items-center text-sm text-green-600 hover:text-green-800">
                            Lihat Semua Jadwal
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                            </svg>
                ...
                <div class="bg-purple-50 rounded-lg p-6 border border-purple-100">
                    ...
                    <div class="mt-4">
                        ...
                        @if($pengajuanJudul && $pengajuanJudul->approved_ta == 'berjalan')
                            <a href="" class="mt-4 inline-flex items-center text-sm text-purple-600 hover:text-purple-800">
                                Upload Dokumen Baru
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                @foreach($jadwalMendatang as $jadwal)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                @if($jadwal->dosen->gambar)
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <img class="h-10 w-10 rounded-full" src="{{ asset('storage/' . $jadwal->dosen->gambar) }}" alt="{{ $jadwal->dosen->nama_lengkap }}">
                                                    </div>
                                                @else
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $jadwal->tanggal_pengajuan->format('d F Y') }}</div>
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-4">
                                    <a href="" class="text-sm font-medium text-yellow-700 hover:text-yellow-600">
