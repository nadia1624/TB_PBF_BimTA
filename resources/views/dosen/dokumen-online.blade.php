        ...
        <div class="flex">
            ...
            <div>
                ...
                <div class="mt-4">
                    ...
                    <!-- File Link - Updated with direct link and better styling -->
                    <a href="{{ asset('storage/' . $item->dokumen_mahasiswa) }}"
                       ...
                       target="_blank">
                        ...
                        <div>
                            ...
                            <span class="text-xs text-gray-500">Klik untuk membuka dokumen</span>
                        </div>
                    </a>
                </div>
                @else
