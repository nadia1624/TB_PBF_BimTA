    ...
    <div class="bg-white p-6 rounded-lg shadow-sm mb-4 document-item"
        ...
        <div class="mt-4">
            ...
            <div class="flex items-center">
                ...
                <span class="text-sm text-gray-500">{{ ucfirst($item->bab ?? 'Dokumen') }}</span>
            </div>

            <!-- File Link -->
            <a href="{{ route('dosen.dokumen.download-mahasiswa', $item->id) }}" class="text-blue-500 hover:underline mt-2 inline-block">
