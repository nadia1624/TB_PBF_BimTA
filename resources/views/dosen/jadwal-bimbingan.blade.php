            ...
            <div class="border rounded-lg p-4">
                ...
                <div class="grid grid-cols-1 gap-2">
                    ...
                    <div class="flex items-center mt-2">
                        <a href="{{ route('dosen.dokumen.show', $jadwal->id) }}" class="inline-flex items-center px-3 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors duration-150 ease-in-out">
                    ...
                    <tr class="border-t hover:bg-gray-50" data-id="{{ $jadwal->id }}" data-metode="{{ $jadwal->metode }}">
                        ...
                        <td class="py-3 px-4">
                            <div class="flex space-x-2">
                                ...
                                @endif
                                <a href="{{ route('dosen.dokumen.show', $jadwal->id) }}" class="bg-green-500 text-white p-2 rounded-md" title="Detail">
                                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    </svg>
