...
Route::middleware(['auth', 'role:dosen'])->prefix('dosen')->name('dosen.')->group(function () {
    ...
    // Dokumen Bimbingan
    Route::get('/dokumen/{id}', [JadwalBimbinganController::class, 'showDocument'])->name('dokumen.show');
    Route::post('/dokumen/{id}', [JadwalBimbinganController::class, 'updateDocument'])->name('dokumen.update');
});
